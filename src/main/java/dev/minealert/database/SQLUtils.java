...
@ModuleInfo(moduleName = "SQL Utils", moduleDesc = "SQL Utils to make it easier to execute SQL Queries", moduleType = ModuleType.INSTANCE)
public class SQLUtils extends AbstractModuleLoader {
