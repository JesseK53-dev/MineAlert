...
public enum Lang {
    ...
    public String toConfigString() {
        AtomicReference<LangFile> langFileFetcher = Atomics.newReference();
        AbstractModuleLoader.getModule(LangFile.class).ifPresent(langFileFetcher::set);
        return langFileFetcher.get().getFileConfiguration().getString(this.path, this.value);
    }
